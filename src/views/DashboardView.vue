    ...
    <div class="dashboard-view">
      ...
      <div class="view-header">
        <div class="view-header-content">
          <h2 class="view-title">📊 Dashboard Analítico</h2>
          <p class="view-description">
            Panel de métricas y análisis en tiempo real para 
...
const handleContentLoaded = () => {
  ...
  appStore.addToLog('[DashboardView] Content loaded', 'info')
}
...
onMounted(() => {
  console.log('📊 DashboardView mounted with MainLayout')
  appStore.addToLog('[DashboardView] Mounted', 'info')
  
  // Sincronizar tab activo
  appStore.setActiveTab('dashboard')
  
  // Actualizar título
  document.title = 'Dashboard - Benova Multi-Tenant Backend'
})

onUnmounted(() => {
  console.log('📊 DashboardView unmounted')
  appStore.addToLog('[DashboardView] Unmounted', 'info')
})
</script>
