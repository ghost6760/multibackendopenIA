<!-- src/views/DocumentosView.vue - VERSIÓN FINAL -->
<template>
  <MainLayout>
    <div class="documentos-view">
      ...
      <div class="view-header">
        <div class="view-header-content">
          <h2 class="view-title">📄 Gestión de Documentos</h2>
          <p class="view-description">
            Administra documentos para 
      ...
      <!-- Contenido principal - DocumentsTab -->
...
const handleContentLoaded = () => {
  ...
  appStore.addToLog('[DocumentosView] Content loaded', 'info')
}
...
onMounted(() => {
  console.log('📄 DocumentosView mounted with MainLayout')
  appStore.addToLog('[DocumentosView] Mounted', 'info')
  
  // Sincronizar el tab activo en el store (para cuando vuelvan a MainAppView)
  appStore.setActiveTab('documents')
  
  // Actualizar título de la página
  document.title = 'Documentos - Benova Multi-Tenant Backend'
})

onUnmounted(() => {
  console.log('📄 DocumentosView unmounted')
  appStore.addToLog('[DocumentosView] Unmounted', 'info')
})
</script>
